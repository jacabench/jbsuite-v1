...
int main() {
 	...
 	dtype_t O3_pool[L3_POOL_FMAP_SIZE];
 	...
 	for (size_t epoch = 0; epoch < NUM_EPOCHS; ++epoch) {
 	 	...
 	 	for (long i = 0; i < N_TRAIN_SAMPLES; i += BATCH_SIZE) {
 	 	 	...
 	 	 	for (size_t sample_idx = 0; sample_idx < current_batch_size; ++sample_idx) {
 	 	 	 	...
 	 	 	 	cnn_fwd(padded_input, W1, B1, O1, W2, B2, O2, W3, B3, O3, O3_pool, W_fc1, B_fc1, O_fc1, W_fc2, B_fc2, O_fc2, max_indices3);
 	 	 	 	cnn_bwd(padded_input, current_sample_LABEL, O1, O2, O3, O3_pool, O_fc1, O_fc2, W1, dW1, dB1, W2, dW2, dB2, W3, dW3, dB3, W_fc1, dW_fc1, dB_fc1, W_fc2, dW_fc2, dB_fc2, dI_fc1, dI1, dI3, dI2, dI_fc2, max_indices3);
 	 	 	}
