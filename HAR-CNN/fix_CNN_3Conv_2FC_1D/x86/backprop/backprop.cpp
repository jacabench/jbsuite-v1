...
void cnn_fwd(const dtype_t I[CONV_FLAT_SIZE],
                ...
                const dtype_t W3[M3*C3*R3], const dtype_t B3[M3], dtype_t O3[L3_FMAP_SIZE], dtype_t O3_pool[L3_POOL_FMAP_SIZE],
                ...
                int max_indices3[L3_POOL_FMAP_SIZE]) {
	...
	maxpool_1d_fwd_with_indices(O3, O3_pool, max_indices3, M3, E3, L3_POOL_E, L3_POOL_K, L3_POOL_S);
	fc_layer_fwd(O3_pool, W_fc1, B_fc1, O_fc1, FC1_IN_SIZE, FC1_OUT_SIZE);
...
void cnn_bwd(const dtype_t I[CONV_FLAT_SIZE], const size_t LABEL[1],
             ...
             const dtype_t O3[L3_FMAP_SIZE], const dtype_t O3_pool[L3_POOL_FMAP_SIZE],
             ...
             dtype_t dI_fc1[CONV_FLAT_SIZE], dtype_t dI1[C1*H1*(GLOBAL_DIM==2?H1:1)], dtype_t dI3[L2_FMAP_SIZE], dtype_t dI2[L1_FMAP_SIZE], dtype_t dI_fc2[FC1_OUT_SIZE],
             const int max_indices3[L3_POOL_FMAP_SIZE]) {
	...
	fc_layer_bwd(O3_pool, W_fc1, d_relu_out_fc1, dI_fc1, dW_fc1, dB_fc1, FC1_IN_SIZE, FC1_OUT_SIZE);
	dtype_t dI3_pool[L3_FMAP_SIZE];
	maxpool_1d_bwd(dI_fc1, max_indices3, dI3_pool, L3_FMAP_SIZE, L3_POOL_FMAP_SIZE);
	dtype_t dI3_relu[L3_FMAP_SIZE];
	relu_bwd(L3_FMAP_SIZE, O3, dI3_pool, dI3_relu);
