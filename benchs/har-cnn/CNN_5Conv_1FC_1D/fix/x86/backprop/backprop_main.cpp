...
int main() {
 	...
 	const std::string TRAIN_DATA_FILE = "../../../train_windowed_channel3_windowsize10_class6.dat";
 	const std::string TEST_DATA_FILE = "../../../test_windowed_channel3_windowsize10_class6.dat";
