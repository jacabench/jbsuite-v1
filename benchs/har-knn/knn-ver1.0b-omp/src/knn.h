...
void update_3_best(DATA_TYPE distance, CLASS_ID_TYPE classID,
				BestPoint *best_3x_points);

void get_3_NN(Point *new_point, Point *known_points, int num_points, BestPoint *best_points, BestPoint *best_3x_points, int num_features);
...
void initialize_best(BestPoint *best_kx_points, K_TYPE k);
...
void update_best(DATA_TYPE distance, CLASS_ID_TYPE classID,
				BestPoint *best_kx_points, K_TYPE k);

void get_k_NN(Point *new_point, Point *known_points, int num_points, BestPoint *best_points, BestPoint *best_kx_points, K_TYPE k,  int num_features);
